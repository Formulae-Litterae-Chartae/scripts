...
pattern = re.compile(r'fu2|ko2|le1|le3|m4|p3|p12|p16')
...
xmls = [x for x in glob(os.path.join(orig, 'data/**/*lat*.xml'), recursive=True) if re.search(r'marmoutier_dunois|marmoutier_vendomois', x)]
