...
pattern = re.compile(r'fu2|ko2|le1|le3|m4|p3|p8|p10|p12|p12s|p14|p16|p16a|formulae:s\.|v6|v8|v9|wa1')
...
xmls = [x for x in glob(os.path.join(orig, 'data/**/*lat*.xml'), recursive=True) if re.search(r'stgallen', x)]
