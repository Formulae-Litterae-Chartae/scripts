...
xmls = list()
for corpus in ['andecavensis', 'auvergne', 'flavigny', 'formulae_marculfinae', 'marculf', 'marmoutier_dunois', 'marmoutier_serfs', 'marmoutier_vendomois', 'marmoutier_vendomois_appendix', 'telma_cormery', 'telma_martin_tours', 'tours', 'tours_ueberarbeitung']: # 'telma_marmoutier', 
