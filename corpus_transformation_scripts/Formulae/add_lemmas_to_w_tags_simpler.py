...
xmls = list()
for corpus in ['andecavensis', 'marculf', 'marmoutier_serfs', 'auvergne', 'flavigny', 'marmoutier_vendomois', 'marmoutier_vendomois_appendix', 'marmoutier_dunois', 'telma_cormery', 'telma_marmoutier', 'telma_martin_tours', 'tours', 'tours_ueberarbeitung']:
